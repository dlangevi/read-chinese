<template>
  <div>
    <div
      ...
      bg-gray-900/50 "
    >
      <div class="modal-box flex flex-col items-center bg-base-100">
        <div class="relative my-4 h-32 w-64">
          <div
            class="absolute top-1/2 left-1/2
          -translate-x-1/2 -translate-y-1/2"
          >
            <div class="flex items-center gap-4">
              <p class="text-accent">{{ api.loadingText }}</p>
              <div role="status">
                <svg
                  aria-hidden="true"
                  class="mr-2 h-8 w-8 animate-spin fill-accent text-base-300"
                  viewBox="0 0 100 101"
                  fill="none"
